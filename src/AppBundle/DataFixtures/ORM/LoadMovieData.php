...
class LoadMovieData extends AbstractFixture implements OrderedFixtureInterface
{
    public function load(ObjectManager $manager)
    {
        ...
        $actor1 = $manager->getRepository("AppBundle:Actor")->findOneByLastName("Reno");
        $actor2 = $manager->getRepository("AppBundle:Actor")->findOneByLastName("Deneuve");
        $actor3 = $manager->getRepository("AppBundle:Actor")->findOneByLastName("Dujardin");
        $actor4 = $manager->getRepository("AppBundle:Actor")->findOneByLastName("Portman");

        $hashTag1 = $manager->getRepository("AppBundle:HashTag")->findOneByName("#HashTag 1");
        $hashTag2 = $manager->getRepository("AppBundle:HashTag")->findOneByName("#HashTag 2");
        $hashTag3 = $manager->getRepository("AppBundle:HashTag")->findOneByName("#HashTag 3");
        $hashTag4 = $manager->getRepository("AppBundle:HashTag")->findOneByName("#HashTag 4");
